...
def parse_args(argv):
    ...
    parser.add_argument("--lambda_list",nargs='+', type=float,default= [0.0025],help="Bit-rate distortion parameter (default: %(default)s)",)
    ...
    parser.add_argument("--gauss_beta",default=[10,10,10],nargs='+', type=int,help="gauss_beta",) #zio caro
    ...
    parser.add_argument("--gauss_trainable",default=["no","no","no"],nargs='+', type=str,help="gauss_beta")

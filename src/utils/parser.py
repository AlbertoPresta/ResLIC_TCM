...
def parse_args(argv):
    ...
    parser.add_argument("-m","--model",default= "wacnn_stanh",choices=models_dict.keys(),help="Model architecture (default: %(default)s)",)
    ...
    parser.add_argument("--lambda_list",nargs='+', type=float,default= [0.0483, 0.0067, 0.0018],help="Bit-rate distortion parameter (default: %(default)s)",)
    ...
    parser.add_argument("--quality", type=int, default=6, help="quality")
    parser.add_argument("--clip_max_norm",default=1.0,type=float,help="gradient clipping max norm (default: %(default)s",)
    parser.add_argument("--checkpoint", type=str, default = "none",help="Path to a checkpoint") #/scratch/StanhLTM/base_models/0.0067.pth.tar
    ...
    parser.add_argument("--continue_train", action="store_true", default=True) #ddddd
    parser.add_argument("--removing_mean", action="store_true")
    parser.add_argument("--multiple_decoder", action="store_true")

    parser.add_argument("--freeze", action="store_true")


    parser.add_argument("--gauss_beta",default=[15,15,15],nargs='+', type=int,help="gauss_beta",)
    ...
    parser.add_argument("--wandb_name", type=str, default = "Compare_2022_stanh_scratch",help="Path to a checkpoint")

...
def parse_args(argv):
    ...
    parser.add_argument("--lambda",dest="lmbda",type=float,default=0.0007,help="Bit-rate distortion parameter (default: %(default)s)",)
    ...
    parser.add_argument("--checkpoint", type=str, default = "/scratch/StanhLTM/base_models/0.0067.pth.tar",help="Path to a checkpoint")

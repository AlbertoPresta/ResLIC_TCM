...
from .gain_utils import get_scale_table, conv, deconv, update_registered_buffers , SFT, UpConv2d
...
class SCGainedHyperprior(CompressionModel):
    '''
    Bottleneck scaling version.
    ...
    def __init__(self,  N = 192, M = 320,lmbda_list = [0.043],  **kwargs):
        ...
        self.lmbda = lmbda_list # [0.05, 0.03, 0.02, 0.01, 0.005, 0.003, 0.001, 0.0003]  # mxh add from HUAWEI CVPR2021 Gained...
